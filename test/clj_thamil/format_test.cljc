...
(deftest cursor-pos-test
  (let [s1 "aldsk சிக்கல் sdfsdf234234lsdflksjdf Zürich"
    ...
    (testing "cursor position"
      ...
      (testing "cursor adjust"
        (is (= 2 (cursor-adjust s4 3 :to-first)))
        (is (= 4 (cursor-adjust s4 3 :to-last)))
        (is (= 4 (cursor-adjust s4 3 nil))) 
        (is (= 2 (cursor-adjust s4 2 :to-first)))
        (is (= 2 (cursor-adjust s4 2 :to-last)))
        (is (= 2 (cursor-adjust s4 2 nil))) 
        (is (= 0 (cursor-adjust s4 0 :to-first)))
        (is (= 0 (cursor-adjust s4 0 :to-last)))
        (is (= 0 (cursor-adjust s4 0 nil))) 
        (is (= 7 (cursor-adjust s4 7 :to-first)))
        (is (= 7 (cursor-adjust s4 7 :to-last)))
        (is (= 7 (cursor-adjust s4 7 nil)))))))
