...
(வரையறு-செயல்கூறு சரம்->ஒலியன்கள் [சொல்] (சரம்->எழுத்துகள் fmt/phoneme-trie சொல்))
  ...
  (வைத்துக்கொள் [எழுத்துகள் (சரம்->எழுத்துகள் சொல்)
    ...
    (எனில் (மற்றும் (= "உக்கு" வே)
                 (அல்லது (பெறு #{"இ" "ஈ" "ஐ"} (கடைசி ஒலியன்கள்))
                        (எதாவது (செயல்கூறு [சரம்] (fmt/seq-prefix?
                                                 (-> சொல் சரம்->ஒலியன்கள் புரட்டு)
                                                 (-> சரம் சரம்->ஒலியன்கள் புரட்டு)))
                                ["ஆய்" "ஒய்"])))
      (வேற்றுமை சொல் "க்கு")
        (-> சொல்
